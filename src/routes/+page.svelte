	...
	{#each birthdayInfo as meta}
		<div class="card md:card-side bg-base-100 shadow-xl">
			...
			<div class="card-body text-center w-full md:text-start">
				<h5 class="card-title mx-auto">{meta.name} {meta.birthinfo}</h5>
...
<footer class="footer footer-center bg-base-200 p-10">
	<div>
		<div class="grid grid-flow-col gap-8">
			<a href="https://twitter.com/AshishKhuraishy">
				<svg
			...
			<a href="https://github.com/ashishkhuraishy" >
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="h-4 w-4"
					fill="currentColor"
			...
			<a href="https://www.linkedin.com/in/ashish-khuraishy/" >
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="h-4 w-4"
					fill="currentColor"
